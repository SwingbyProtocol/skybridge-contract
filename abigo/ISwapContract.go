...
// Churn is a paid mutator transaction binding the contract method 0x52dcd6b6.
//
// Solidity: function churn(address _newOwner, address[] _nodes, bool[] _isRemoved, uint8 _churnedInCount, uint8 _tssThreshold, uint256 _totalStakedAmount) returns(bool)
func (_ISwapContract *ISwapContractTransactor) Churn(opts *bind.TransactOpts, _newOwner common.Address, _nodes []common.Address, _isRemoved []bool, _churnedInCount uint8, _tssThreshold uint8, _totalStakedAmount *big.Int) (*types.Transaction, error) {
	return _ISwapContract.contract.Transact(opts, "churn", _newOwner, _nodes, _isRemoved, _churnedInCount, _tssThreshold, _totalStakedAmount)
}

// Churn is a paid mutator transaction binding the contract method 0x52dcd6b6.
//
// Solidity: function churn(address _newOwner, address[] _nodes, bool[] _isRemoved, uint8 _churnedInCount, uint8 _tssThreshold, uint256 _totalStakedAmount) returns(bool)
func (_ISwapContract *ISwapContractSession) Churn(_newOwner common.Address, _nodes []common.Address, _isRemoved []bool, _churnedInCount uint8, _tssThreshold uint8, _totalStakedAmount *big.Int) (*types.Transaction, error) {
	return _ISwapContract.Contract.Churn(&_ISwapContract.TransactOpts, _newOwner, _nodes, _isRemoved, _churnedInCount, _tssThreshold, _totalStakedAmount)
}

// Churn is a paid mutator transaction binding the contract method 0x52dcd6b6.
//
// Solidity: function churn(address _newOwner, address[] _nodes, bool[] _isRemoved, uint8 _churnedInCount, uint8 _tssThreshold, uint256 _totalStakedAmount) returns(bool)
func (_ISwapContract *ISwapContractTransactorSession) Churn(_newOwner common.Address, _nodes []common.Address, _isRemoved []bool, _churnedInCount uint8, _tssThreshold uint8, _totalStakedAmount *big.Int) (*types.Transaction, error) {
	return _ISwapContract.Contract.Churn(&_ISwapContract.TransactOpts, _newOwner, _nodes, _isRemoved, _churnedInCount, _tssThreshold, _totalStakedAmount)
}
...
func (_ISwapContract *ISwapContractTransactor) CollectSwapFeesForBTC(opts *bind.TransactOpts, _incomingAmount *big.Int, _minerFee *big.Int, _rewardsAmount *big.Int, _spenders []common.Address, _swapAmounts []*big.Int, _isUpdatelimitBTCForSPFlow2 bool) (*types.Transaction, error) {
	return _ISwapContract.contract.Transact(opts, "collectSwapFeesForBTC", _incomingAmount, _minerFee, _rewardsAmount, _spenders, _swapAmounts, _isUpdatelimitBTCForSPFlow2)
}

// CollectSwapFeesForBTC is a paid mutator transaction binding the contract method 0xdcc5f0c8.
//
// Solidity: function collectSwapFeesForBTC(uint256 _incomingAmount, uint256 _minerFee, uint256 _rewardsAmount, address[] _spenders, uint256[] _swapAmounts, bool _isUpdatelimitBTCForSPFlow2) returns(bool)
func (_ISwapContract *ISwapContractSession) CollectSwapFeesForBTC(_incomingAmount *big.Int, _minerFee *big.Int, _rewardsAmount *big.Int, _spenders []common.Address, _swapAmounts []*big.Int, _isUpdatelimitBTCForSPFlow2 bool) (*types.Transaction, error) {
	return _ISwapContract.Contract.CollectSwapFeesForBTC(&_ISwapContract.TransactOpts, _incomingAmount, _minerFee, _rewardsAmount, _spenders, _swapAmounts, _isUpdatelimitBTCForSPFlow2)
}

// CollectSwapFeesForBTC is a paid mutator transaction binding the contract method 0xdcc5f0c8.
//
// Solidity: function collectSwapFeesForBTC(uint256 _incomingAmount, uint256 _minerFee, uint256 _rewardsAmount, address[] _spenders, uint256[] _swapAmounts, bool _isUpdatelimitBTCForSPFlow2) returns(bool)
func (_ISwapContract *ISwapContractTransactorSession) CollectSwapFeesForBTC(_incomingAmount *big.Int, _minerFee *big.Int, _rewardsAmount *big.Int, _spenders []common.Address, _swapAmounts []*big.Int, _isUpdatelimitBTCForSPFlow2 bool) (*types.Transaction, error) {
	return _ISwapContract.Contract.CollectSwapFeesForBTC(&_ISwapContract.TransactOpts, _incomingAmount, _minerFee, _rewardsAmount, _spenders, _swapAmounts, _isUpdatelimitBTCForSPFlow2)
}
...
func (_ISwapContract *ISwapContractTransactor) SpCleanUpOldTXs(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _ISwapContract.contract.Transact(opts, "spCleanUpOldTXs")
}

// SpCleanUpOldTXs is a paid mutator transaction binding the contract method 0xb9ae0adc.
//
// Solidity: function spCleanUpOldTXs() returns()
func (_ISwapContract *ISwapContractSession) SpCleanUpOldTXs() (*types.Transaction, error) {
	return _ISwapContract.Contract.SpCleanUpOldTXs(&_ISwapContract.TransactOpts)
}

// SpCleanUpOldTXs is a paid mutator transaction binding the contract method 0xb9ae0adc.
//
// Solidity: function spCleanUpOldTXs() returns()
func (_ISwapContract *ISwapContractTransactorSession) SpCleanUpOldTXs() (*types.Transaction, error) {
	return _ISwapContract.Contract.SpCleanUpOldTXs(&_ISwapContract.TransactOpts)
}
