...
func (_ISwapContract *ISwapContractTransactor) Churn(opts *bind.TransactOpts, _newOwner common.Address, _rewardAddressAndAmounts [][32]byte, _isRemoved []bool, _churnedInCount uint8, _tssThreshold uint8, _nodeRewardsRatio uint8) (*types.Transaction, error) {
	return _ISwapContract.contract.Transact(opts, "churn", _newOwner, _rewardAddressAndAmounts, _isRemoved, _churnedInCount, _tssThreshold, _nodeRewardsRatio)
}

// Churn is a paid mutator transaction binding the contract method 0x2e276e4e.
//
// Solidity: function churn(address _newOwner, bytes32[] _rewardAddressAndAmounts, bool[] _isRemoved, uint8 _churnedInCount, uint8 _tssThreshold, uint8 _nodeRewardsRatio) returns(bool)
func (_ISwapContract *ISwapContractSession) Churn(_newOwner common.Address, _rewardAddressAndAmounts [][32]byte, _isRemoved []bool, _churnedInCount uint8, _tssThreshold uint8, _nodeRewardsRatio uint8) (*types.Transaction, error) {
	return _ISwapContract.Contract.Churn(&_ISwapContract.TransactOpts, _newOwner, _rewardAddressAndAmounts, _isRemoved, _churnedInCount, _tssThreshold, _nodeRewardsRatio)
}

// Churn is a paid mutator transaction binding the contract method 0x2e276e4e.
//
// Solidity: function churn(address _newOwner, bytes32[] _rewardAddressAndAmounts, bool[] _isRemoved, uint8 _churnedInCount, uint8 _tssThreshold, uint8 _nodeRewardsRatio) returns(bool)
func (_ISwapContract *ISwapContractTransactorSession) Churn(_newOwner common.Address, _rewardAddressAndAmounts [][32]byte, _isRemoved []bool, _churnedInCount uint8, _tssThreshold uint8, _nodeRewardsRatio uint8) (*types.Transaction, error) {
	return _ISwapContract.Contract.Churn(&_ISwapContract.TransactOpts, _newOwner, _rewardAddressAndAmounts, _isRemoved, _churnedInCount, _tssThreshold, _nodeRewardsRatio)
}
...
// GetMinimumAmountOfLPTokens is a paid mutator transaction binding the contract method 0xeee3bab0.
//
// Solidity: function getMinimumAmountOfLPTokens(uint256 _withdrawalFeeBPS, uint256 _minerFees) returns(uint256)
func (_ISwapContract *ISwapContractTransactor) GetMinimumAmountOfLPTokens(opts *bind.TransactOpts, _withdrawalFeeBPS *big.Int, _minerFees *big.Int) (*types.Transaction, error) {
	return _ISwapContract.contract.Transact(opts, "getMinimumAmountOfLPTokens", _withdrawalFeeBPS, _minerFees)
}

// GetMinimumAmountOfLPTokens is a paid mutator transaction binding the contract method 0xeee3bab0.
//
// Solidity: function getMinimumAmountOfLPTokens(uint256 _withdrawalFeeBPS, uint256 _minerFees) returns(uint256)
func (_ISwapContract *ISwapContractSession) GetMinimumAmountOfLPTokens(_withdrawalFeeBPS *big.Int, _minerFees *big.Int) (*types.Transaction, error) {
	return _ISwapContract.Contract.GetMinimumAmountOfLPTokens(&_ISwapContract.TransactOpts, _withdrawalFeeBPS, _minerFees)
}

// GetMinimumAmountOfLPTokens is a paid mutator transaction binding the contract method 0xeee3bab0.
//
// Solidity: function getMinimumAmountOfLPTokens(uint256 _withdrawalFeeBPS, uint256 _minerFees) returns(uint256)
func (_ISwapContract *ISwapContractTransactorSession) GetMinimumAmountOfLPTokens(_withdrawalFeeBPS *big.Int, _minerFees *big.Int) (*types.Transaction, error) {
	return _ISwapContract.Contract.GetMinimumAmountOfLPTokens(&_ISwapContract.TransactOpts, _withdrawalFeeBPS, _minerFees)
}
...
func (_ISwapContract *ISwapContractTransactor) RecordOutcomingFloat(opts *bind.TransactOpts, _token common.Address, _addressesAndAmountOfLPtoken [32]byte, _withdrawalFeeBPS *big.Int, _minerFee *big.Int, _txid [32]byte) (*types.Transaction, error) {
	return _ISwapContract.contract.Transact(opts, "recordOutcomingFloat", _token, _addressesAndAmountOfLPtoken, _withdrawalFeeBPS, _minerFee, _txid)
}

// RecordOutcomingFloat is a paid mutator transaction binding the contract method 0x76a8695c.
//
// Solidity: function recordOutcomingFloat(address _token, bytes32 _addressesAndAmountOfLPtoken, uint256 _withdrawalFeeBPS, uint256 _minerFee, bytes32 _txid) returns(bool)
func (_ISwapContract *ISwapContractSession) RecordOutcomingFloat(_token common.Address, _addressesAndAmountOfLPtoken [32]byte, _withdrawalFeeBPS *big.Int, _minerFee *big.Int, _txid [32]byte) (*types.Transaction, error) {
	return _ISwapContract.Contract.RecordOutcomingFloat(&_ISwapContract.TransactOpts, _token, _addressesAndAmountOfLPtoken, _withdrawalFeeBPS, _minerFee, _txid)
}

// RecordOutcomingFloat is a paid mutator transaction binding the contract method 0x76a8695c.
//
// Solidity: function recordOutcomingFloat(address _token, bytes32 _addressesAndAmountOfLPtoken, uint256 _withdrawalFeeBPS, uint256 _minerFee, bytes32 _txid) returns(bool)
func (_ISwapContract *ISwapContractTransactorSession) RecordOutcomingFloat(_token common.Address, _addressesAndAmountOfLPtoken [32]byte, _withdrawalFeeBPS *big.Int, _minerFee *big.Int, _txid [32]byte) (*types.Transaction, error) {
	return _ISwapContract.Contract.RecordOutcomingFloat(&_ISwapContract.TransactOpts, _token, _addressesAndAmountOfLPtoken, _withdrawalFeeBPS, _minerFee, _txid)
}
