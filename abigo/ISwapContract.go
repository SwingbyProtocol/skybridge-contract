...
// GetFloatReserve is a paid mutator transaction binding the contract method 0x28bb89ed.
//
// Solidity: function getFloatReserve(address _tokenA, address _tokenB, bool _mergeRewards) returns(uint256 reserveA, uint256 reserveB)
func (_ISwapContract *ISwapContractTransactor) GetFloatReserve(opts *bind.TransactOpts, _tokenA common.Address, _tokenB common.Address, _mergeRewards bool) (*types.Transaction, error) {
	return _ISwapContract.contract.Transact(opts, "getFloatReserve", _tokenA, _tokenB, _mergeRewards)
}

// GetFloatReserve is a paid mutator transaction binding the contract method 0x28bb89ed.
//
// Solidity: function getFloatReserve(address _tokenA, address _tokenB, bool _mergeRewards) returns(uint256 reserveA, uint256 reserveB)
func (_ISwapContract *ISwapContractSession) GetFloatReserve(_tokenA common.Address, _tokenB common.Address, _mergeRewards bool) (*types.Transaction, error) {
	return _ISwapContract.Contract.GetFloatReserve(&_ISwapContract.TransactOpts, _tokenA, _tokenB, _mergeRewards)
}

// GetFloatReserve is a paid mutator transaction binding the contract method 0x28bb89ed.
//
// Solidity: function getFloatReserve(address _tokenA, address _tokenB, bool _mergeRewards) returns(uint256 reserveA, uint256 reserveB)
func (_ISwapContract *ISwapContractTransactorSession) GetFloatReserve(_tokenA common.Address, _tokenB common.Address, _mergeRewards bool) (*types.Transaction, error) {
	return _ISwapContract.Contract.GetFloatReserve(&_ISwapContract.TransactOpts, _tokenA, _tokenB, _mergeRewards)
}
