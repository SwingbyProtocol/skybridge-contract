...
func (_SwapContract *SwapContractCaller) GetMinimumAmountOfLPTokens(opts *bind.CallOpts, _minerFees *big.Int) (*big.Int, *big.Int, error) {
	var out []interface{}
	err := _SwapContract.contract.Call(opts, &out, "getMinimumAmountOfLPTokens", _minerFees)
...
//
// Solidity: function getMinimumAmountOfLPTokens(uint256 _minerFees) view returns(uint256, uint256)
func (_SwapContract *SwapContractSession) GetMinimumAmountOfLPTokens(_minerFees *big.Int) (*big.Int, *big.Int, error) {
	return _SwapContract.Contract.GetMinimumAmountOfLPTokens(&_SwapContract.CallOpts, _minerFees)
}

// GetMinimumAmountOfLPTokens is a free data retrieval call binding the contract method 0xba0b8e95.
//
// Solidity: function getMinimumAmountOfLPTokens(uint256 _minerFees) view returns(uint256, uint256)
func (_SwapContract *SwapContractCallerSession) GetMinimumAmountOfLPTokens(_minerFees *big.Int) (*big.Int, *big.Int, error) {
	return _SwapContract.Contract.GetMinimumAmountOfLPTokens(&_SwapContract.CallOpts, _minerFees)
}
