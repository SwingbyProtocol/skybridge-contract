...
//
// Solidity: function collectSwapFeesForBTC(address _feeToken, uint256 _incomingAmount, uint256 _rewardsAmount) returns(bool)
func (_SwapContract *SwapContractTransactor) CollectSwapFeesForBTC(opts *bind.TransactOpts, _feeToken common.Address, _incomingAmount *big.Int, _rewardsAmount *big.Int) (*types.Transaction, error) {
	return _SwapContract.contract.Transact(opts, "collectSwapFeesForBTC", _feeToken, _incomingAmount, _rewardsAmount)
}

// CollectSwapFeesForBTC is a paid mutator transaction binding the contract method 0x64399a7f.
//
// Solidity: function collectSwapFeesForBTC(address _feeToken, uint256 _incomingAmount, uint256 _rewardsAmount) returns(bool)
func (_SwapContract *SwapContractSession) CollectSwapFeesForBTC(_feeToken common.Address, _incomingAmount *big.Int, _rewardsAmount *big.Int) (*types.Transaction, error) {
	return _SwapContract.Contract.CollectSwapFeesForBTC(&_SwapContract.TransactOpts, _feeToken, _incomingAmount, _rewardsAmount)
}

// CollectSwapFeesForBTC is a paid mutator transaction binding the contract method 0x64399a7f.
//
// Solidity: function collectSwapFeesForBTC(address _feeToken, uint256 _incomingAmount, uint256 _rewardsAmount) returns(bool)
func (_SwapContract *SwapContractTransactorSession) CollectSwapFeesForBTC(_feeToken common.Address, _incomingAmount *big.Int, _rewardsAmount *big.Int) (*types.Transaction, error) {
	return _SwapContract.Contract.CollectSwapFeesForBTC(&_SwapContract.TransactOpts, _feeToken, _incomingAmount, _rewardsAmount)
}
