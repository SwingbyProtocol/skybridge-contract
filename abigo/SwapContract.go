...
// CheckFlips is a free data retrieval call binding the contract method 0x38c4226b.
//
// Solidity: function _checkFlips(address _token, uint256 _amountOfFloat) view returns(uint8 active)
func (_SwapContract *SwapContractCaller) CheckFlips(opts *bind.CallOpts, _token common.Address, _amountOfFloat *big.Int) (uint8, error) {
	var out []interface{}
	err := _SwapContract.contract.Call(opts, &out, "_checkFlips", _token, _amountOfFloat)
...
//
// Solidity: function _checkFlips(address _token, uint256 _amountOfFloat) view returns(uint8 active)
func (_SwapContract *SwapContractSession) CheckFlips(_token common.Address, _amountOfFloat *big.Int) (uint8, error) {
	return _SwapContract.Contract.CheckFlips(&_SwapContract.CallOpts, _token, _amountOfFloat)
}

// CheckFlips is a free data retrieval call binding the contract method 0x38c4226b.
//
// Solidity: function _checkFlips(address _token, uint256 _amountOfFloat) view returns(uint8 active)
func (_SwapContract *SwapContractCallerSession) CheckFlips(_token common.Address, _amountOfFloat *big.Int) (uint8, error) {
	return _SwapContract.Contract.CheckFlips(&_SwapContract.CallOpts, _token, _amountOfFloat)
}
...
func (_SwapContract *SwapContractTransactor) MultiTransferERC20TightlyPacked(opts *bind.TransactOpts, _token common.Address, _addressesAndAmounts [][32]byte, _rewardsAmount *big.Int) (*types.Transaction, error) {
	return _SwapContract.contract.Transact(opts, "multiTransferERC20TightlyPacked", _token, _addressesAndAmounts, _rewardsAmount)
}

// MultiTransferERC20TightlyPacked is a paid mutator transaction binding the contract method 0x26a96f2b.
//
// Solidity: function multiTransferERC20TightlyPacked(address _token, bytes32[] _addressesAndAmounts, uint256 _rewardsAmount) returns(bool)
func (_SwapContract *SwapContractSession) MultiTransferERC20TightlyPacked(_token common.Address, _addressesAndAmounts [][32]byte, _rewardsAmount *big.Int) (*types.Transaction, error) {
	return _SwapContract.Contract.MultiTransferERC20TightlyPacked(&_SwapContract.TransactOpts, _token, _addressesAndAmounts, _rewardsAmount)
}

// MultiTransferERC20TightlyPacked is a paid mutator transaction binding the contract method 0x26a96f2b.
//
// Solidity: function multiTransferERC20TightlyPacked(address _token, bytes32[] _addressesAndAmounts, uint256 _rewardsAmount) returns(bool)
func (_SwapContract *SwapContractTransactorSession) MultiTransferERC20TightlyPacked(_token common.Address, _addressesAndAmounts [][32]byte, _rewardsAmount *big.Int) (*types.Transaction, error) {
	return _SwapContract.Contract.MultiTransferERC20TightlyPacked(&_SwapContract.TransactOpts, _token, _addressesAndAmounts, _rewardsAmount)
}
