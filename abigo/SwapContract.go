...
// RecordSkyPoolsTX is a paid mutator transaction binding the contract method 0x0ef73c83.
//
// Solidity: function recordSkyPoolsTX(address _to, uint256 _totalSwapped, uint256 _rewardsAmount) returns(bool)
func (_SwapContract *SwapContractTransactor) RecordSkyPoolsTX(opts *bind.TransactOpts, _to common.Address, _totalSwapped *big.Int, _rewardsAmount *big.Int) (*types.Transaction, error) {
	return _SwapContract.contract.Transact(opts, "recordSkyPoolsTX", _to, _totalSwapped, _rewardsAmount)
}

// RecordSkyPoolsTX is a paid mutator transaction binding the contract method 0x0ef73c83.
//
// Solidity: function recordSkyPoolsTX(address _to, uint256 _totalSwapped, uint256 _rewardsAmount) returns(bool)
func (_SwapContract *SwapContractSession) RecordSkyPoolsTX(_to common.Address, _totalSwapped *big.Int, _rewardsAmount *big.Int) (*types.Transaction, error) {
	return _SwapContract.Contract.RecordSkyPoolsTX(&_SwapContract.TransactOpts, _to, _totalSwapped, _rewardsAmount)
}

// RecordSkyPoolsTX is a paid mutator transaction binding the contract method 0x0ef73c83.
//
// Solidity: function recordSkyPoolsTX(address _to, uint256 _totalSwapped, uint256 _rewardsAmount) returns(bool)
func (_SwapContract *SwapContractTransactorSession) RecordSkyPoolsTX(_to common.Address, _totalSwapped *big.Int, _rewardsAmount *big.Int) (*types.Transaction, error) {
	return _SwapContract.Contract.RecordSkyPoolsTX(&_SwapContract.TransactOpts, _to, _totalSwapped, _rewardsAmount)
}
