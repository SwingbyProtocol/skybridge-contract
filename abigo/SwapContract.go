...
// GetMinimumAmountOfLPTokens is a free data retrieval call binding the contract method 0xeee3bab0.
//
// Solidity: function getMinimumAmountOfLPTokens(uint256 _withdrawalFeeBPS, uint256 _minerFees) view returns(uint256)
func (_SwapContract *SwapContractCaller) GetMinimumAmountOfLPTokens(opts *bind.CallOpts, _withdrawalFeeBPS *big.Int, _minerFees *big.Int) (*big.Int, error) {
	var out []interface{}
	err := _SwapContract.contract.Call(opts, &out, "getMinimumAmountOfLPTokens", _withdrawalFeeBPS, _minerFees)
...
//
// Solidity: function getMinimumAmountOfLPTokens(uint256 _withdrawalFeeBPS, uint256 _minerFees) view returns(uint256)
func (_SwapContract *SwapContractSession) GetMinimumAmountOfLPTokens(_withdrawalFeeBPS *big.Int, _minerFees *big.Int) (*big.Int, error) {
	return _SwapContract.Contract.GetMinimumAmountOfLPTokens(&_SwapContract.CallOpts, _withdrawalFeeBPS, _minerFees)
}

// GetMinimumAmountOfLPTokens is a free data retrieval call binding the contract method 0xeee3bab0.
//
// Solidity: function getMinimumAmountOfLPTokens(uint256 _withdrawalFeeBPS, uint256 _minerFees) view returns(uint256)
func (_SwapContract *SwapContractCallerSession) GetMinimumAmountOfLPTokens(_withdrawalFeeBPS *big.Int, _minerFees *big.Int) (*big.Int, error) {
	return _SwapContract.Contract.GetMinimumAmountOfLPTokens(&_SwapContract.CallOpts, _withdrawalFeeBPS, _minerFees)
}
...
// Churn is a paid mutator transaction binding the contract method 0x2e276e4e.
//
// Solidity: function churn(address _newOwner, bytes32[] _rewardAddressAndAmounts, bool[] _isRemoved, uint8 _churnedInCount, uint8 _tssThreshold, uint8 _nodeRewardsRatio) returns(bool)
func (_SwapContract *SwapContractTransactor) Churn(opts *bind.TransactOpts, _newOwner common.Address, _rewardAddressAndAmounts [][32]byte, _isRemoved []bool, _churnedInCount uint8, _tssThreshold uint8, _nodeRewardsRatio uint8) (*types.Transaction, error) {
	return _SwapContract.contract.Transact(opts, "churn", _newOwner, _rewardAddressAndAmounts, _isRemoved, _churnedInCount, _tssThreshold, _nodeRewardsRatio)
}

// Churn is a paid mutator transaction binding the contract method 0x2e276e4e.
//
// Solidity: function churn(address _newOwner, bytes32[] _rewardAddressAndAmounts, bool[] _isRemoved, uint8 _churnedInCount, uint8 _tssThreshold, uint8 _nodeRewardsRatio) returns(bool)
func (_SwapContract *SwapContractSession) Churn(_newOwner common.Address, _rewardAddressAndAmounts [][32]byte, _isRemoved []bool, _churnedInCount uint8, _tssThreshold uint8, _nodeRewardsRatio uint8) (*types.Transaction, error) {
	return _SwapContract.Contract.Churn(&_SwapContract.TransactOpts, _newOwner, _rewardAddressAndAmounts, _isRemoved, _churnedInCount, _tssThreshold, _nodeRewardsRatio)
}

// Churn is a paid mutator transaction binding the contract method 0x2e276e4e.
//
// Solidity: function churn(address _newOwner, bytes32[] _rewardAddressAndAmounts, bool[] _isRemoved, uint8 _churnedInCount, uint8 _tssThreshold, uint8 _nodeRewardsRatio) returns(bool)
func (_SwapContract *SwapContractTransactorSession) Churn(_newOwner common.Address, _rewardAddressAndAmounts [][32]byte, _isRemoved []bool, _churnedInCount uint8, _tssThreshold uint8, _nodeRewardsRatio uint8) (*types.Transaction, error) {
	return _SwapContract.Contract.Churn(&_SwapContract.TransactOpts, _newOwner, _rewardAddressAndAmounts, _isRemoved, _churnedInCount, _tssThreshold, _nodeRewardsRatio)
}
...
func (_SwapContract *SwapContractTransactor) CollectSwapFeesForBTC(opts *bind.TransactOpts, _destToken common.Address, _incomingAmount *big.Int, _rewardsAmount *big.Int) (*types.Transaction, error) {
	return _SwapContract.contract.Transact(opts, "collectSwapFeesForBTC", _destToken, _incomingAmount, _rewardsAmount)
}

// CollectSwapFeesForBTC is a paid mutator transaction binding the contract method 0x64399a7f.
//
// Solidity: function collectSwapFeesForBTC(address _destToken, uint256 _incomingAmount, uint256 _rewardsAmount) returns(bool)
func (_SwapContract *SwapContractSession) CollectSwapFeesForBTC(_destToken common.Address, _incomingAmount *big.Int, _rewardsAmount *big.Int) (*types.Transaction, error) {
	return _SwapContract.Contract.CollectSwapFeesForBTC(&_SwapContract.TransactOpts, _destToken, _incomingAmount, _rewardsAmount)
}

// CollectSwapFeesForBTC is a paid mutator transaction binding the contract method 0x64399a7f.
//
// Solidity: function collectSwapFeesForBTC(address _destToken, uint256 _incomingAmount, uint256 _rewardsAmount) returns(bool)
func (_SwapContract *SwapContractTransactorSession) CollectSwapFeesForBTC(_destToken common.Address, _incomingAmount *big.Int, _rewardsAmount *big.Int) (*types.Transaction, error) {
	return _SwapContract.Contract.CollectSwapFeesForBTC(&_SwapContract.TransactOpts, _destToken, _incomingAmount, _rewardsAmount)
}
...
// RecordOutcomingFloat is a paid mutator transaction binding the contract method 0x76a8695c.
//
// Solidity: function recordOutcomingFloat(address _token, bytes32 _addressesAndAmountOfLPtoken, uint256 _withdrawalFeeBPS, uint256 _minerFee, bytes32 _txid) returns(bool)
func (_SwapContract *SwapContractTransactor) RecordOutcomingFloat(opts *bind.TransactOpts, _token common.Address, _addressesAndAmountOfLPtoken [32]byte, _withdrawalFeeBPS *big.Int, _minerFee *big.Int, _txid [32]byte) (*types.Transaction, error) {
	return _SwapContract.contract.Transact(opts, "recordOutcomingFloat", _token, _addressesAndAmountOfLPtoken, _withdrawalFeeBPS, _minerFee, _txid)
}

// RecordOutcomingFloat is a paid mutator transaction binding the contract method 0x76a8695c.
//
// Solidity: function recordOutcomingFloat(address _token, bytes32 _addressesAndAmountOfLPtoken, uint256 _withdrawalFeeBPS, uint256 _minerFee, bytes32 _txid) returns(bool)
func (_SwapContract *SwapContractSession) RecordOutcomingFloat(_token common.Address, _addressesAndAmountOfLPtoken [32]byte, _withdrawalFeeBPS *big.Int, _minerFee *big.Int, _txid [32]byte) (*types.Transaction, error) {
	return _SwapContract.Contract.RecordOutcomingFloat(&_SwapContract.TransactOpts, _token, _addressesAndAmountOfLPtoken, _withdrawalFeeBPS, _minerFee, _txid)
}

// RecordOutcomingFloat is a paid mutator transaction binding the contract method 0x76a8695c.
//
// Solidity: function recordOutcomingFloat(address _token, bytes32 _addressesAndAmountOfLPtoken, uint256 _withdrawalFeeBPS, uint256 _minerFee, bytes32 _txid) returns(bool)
func (_SwapContract *SwapContractTransactorSession) RecordOutcomingFloat(_token common.Address, _addressesAndAmountOfLPtoken [32]byte, _withdrawalFeeBPS *big.Int, _minerFee *big.Int, _txid [32]byte) (*types.Transaction, error) {
	return _SwapContract.Contract.RecordOutcomingFloat(&_SwapContract.TransactOpts, _token, _addressesAndAmountOfLPtoken, _withdrawalFeeBPS, _minerFee, _txid)
}
