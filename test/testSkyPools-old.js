...
describe("SkyPools", () => {
    ...
    describe("SkyPool functions", () => {
        ...
        it('executes paraSwap transactions', async () => {
            ...
            let swingbyETH_Balance = await provider.getBalance(swingbyContractAddress)
            let highValueEthBalance = await provider.getBalance(highValueEthAccount)
            let ownerBalance = await provider.getBalance(owner.address)
            console.log("High Value ETH account balance: ", utils.formatEther(highValueEthBalance).toString())
            console.log("Swingby Contract ETH balance: ", utils.formatEther(swingbyETH_Balance).toString())
            console.log("Swingby Contract wBTC balance: ", swingbywBTC_Balance.toString())
            console.log("Owner ETH balance: ", utils.formatEther(ownerBalance).toString())
